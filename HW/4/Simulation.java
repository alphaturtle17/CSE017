 ...
 * Date: 10/21/22
 * CSE 017
 * Main method for simulation using queue and arraylist (CustomerQueue/ServerList)
 */
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            for(int clock = 0; clock < simTime; clock++){
                serverlist.updateServiceTime(); //also checks if time is up
                if(!queue.isEmpty()){
            ...
            System.out.println("Average service time: " + (double) finishedCustomers / servPM);
            ...
            System.out.println("Average waiting time per customer: " + (double) totalWaitingTime / cusNum);
